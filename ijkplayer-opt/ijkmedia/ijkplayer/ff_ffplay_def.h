...
//added by yuanzc for live play audio delay
#define SAMPLE_MAX_BUFFER_SIZE (2 * 1024)
//end added
...
enum AVRecordState {
    AVRECORD_STATE_UNKNOWN = 0,  
    AVRECORD_STATE_INIT,
    AVRECORD_STATE_RECORDING,
    AVRECORD_STATE_UNINIT
};

//add by yuanzc
enum AVPlayType {
    AVPLAY_LIVE_NORMAL = 0,  
    AVPLAY_PLAYBACK_NORMAL,
    AVPLAY_LIVE_INTERLACE,
    AVPLAY_PLAYBACK_INTERLACE,
};
...
//end added
    ...
    int64_t video_num;                  //video frame number
    int64_t audio_num;                  // audio frame number
