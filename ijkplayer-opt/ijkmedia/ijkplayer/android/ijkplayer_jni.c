...
static jint
IjkMediaPlayer_startRecord(JNIEnv *env, jobject thiz,jstring file,jint vfps)
{
    jint retval = 0;
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static JNINativeMethod g_methods[] = {
    ...
    { "startRecord",            "(Ljava/lang/String;I)I",      (void *) IjkMediaPlayer_startRecord },
    { "stopRecord",             "()I",      (void *) IjkMediaPlayer_stopRecord },
    { "isRecording",            "()Z",      (void *) IjkMediaPlayer_isRecording },
